...
payload = {
    "_id": "17", # can not have the same id as another avocado already in the database. if not sure, just don't include and mongodb will autogenerate an id that can be modified later;
